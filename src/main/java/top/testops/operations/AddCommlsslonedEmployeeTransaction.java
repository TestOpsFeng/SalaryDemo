...
/**
  ...
  * @date 2020/4/23
**/
public class AddCommlsslonedEmployeeTransaction extends AddEmployeeTransaction {
    private int salary;

    public AddCommlsslonedEmployeeTransaction(int id, String name, String address, int salary) {
